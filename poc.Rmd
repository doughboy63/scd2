...
if (have_historic) {
  ...
  log_warning("The historic file targeted (", historic_filename, ") cannot be found!")
}
...
if (have_load) {
  ...
  log_fatal("The load file targeted (", load_filename, ") cannot be found!")
}

# If I don't have a historic file, turn the load file into a historic file. 
if (!have_historic & have_load) {
  log_info("Converting load table (", load_filename, ") into the historic table.")
